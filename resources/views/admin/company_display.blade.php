            ...
            <div class="content-header row">
               <div class="content-header-left col-md-9 col-12 mb-2">
                  <div class="row breadcrumbs-top">
                     <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Display Company</h2>
                        <div class="breadcrumb-wrapper">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item"><a href="index.html">Home</a>
                              </li>
                              <li class="breadcrumb-item active">Display Company
                              </li>
                           </ol>
                        </div>
                     </div>
                           ...
                           <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                              <div class="card-header border-bottom p-1">
                                 <div class="head-label">
                                    <h6 class="mb-0">Display Company with Buttons</h6>
                                 </div>
                              ...
                              <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0" role="grid" aria-describedby="DataTables_Table_0_info" style="width: 1033px;">
                                 <thead>
                                    <tr role="row">
                                       ...
                                       <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 50px;" aria-label="Name: activate to sort column ascending">Company Name</th>
                                       <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" style="width: 60px;" aria-label="Email: activate to sort column ascending">Company Logo</th>
                                 ...
                                 <tbody>
                                    ...
                                    <td>{{ $no++ }}</td>
                                       ...
                                       <td> <img src="{{ asset('uplode/companylogo/' .  $companys->customFile) }}" alt="image" width="100px;" height="100px;"/> </td>
                                        <td> <a class="btn btn-secondary" href="{{ url('company-view',$companys->id) }}" >View</a>
                                        <a class="btn btn-danger" href="{{ url('company-delete',$companys->id) }}" >Delete</a>
                                        <a class="btn btn-primary" href="{{ url('company-edit',$companys->id) }}" >Edit</a>
                                        </td>
                                       @endforeach
                                    </tr>
                                 </tbody>
